...
public class JSON {
    ...
    public static String getDiscriminatorValue(JsonElement readElement, String discriminatorField) {
    ...
    public static Class<?> getClassByDiscriminator(Map<?, ?> classByDiscriminatorValue, String discriminatorValue) {
    ...
    public static class OffsetDateTimeTypeAdapter extends TypeAdapter<OffsetDateTime> {
        ...
        @Override
        public void write(JsonWriter out, OffsetDateTime date)
            throws IOException {
            if (date == null) {
                out.nullValue();
            } else {
    ...
    public class LocalDateTypeAdapter extends TypeAdapter<LocalDate> {
        ...
        @Override
        public void write(JsonWriter out, LocalDate date)
            throws IOException {
            if (date == null) {
                out.nullValue();
            } else {
    ...
    public static class SqlDateTypeAdapter extends TypeAdapter<java.sql.Date> {
        ...
        @Override
        public void write(JsonWriter out, java.sql.Date date)
            throws IOException {
            if (date == null) {
                out.nullValue();
            } else {
